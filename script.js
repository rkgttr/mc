...
tag.src = 'https://cdn.jsdelivr.net/gh/rkgttr/mc@7/script.js';
...
const init = ()=>{
  ...
  addCss('https://cdn.jsdelivr.net/gh/rkgttr/mc@7/new.css');
  ...
  ).src = 'https://cdn.jsdelivr.net/gh/rkgttr/mc@7/Carte-CDA-2022.png';
  
  document.querySelectorAll(
    'img[src*="logo-header"], img[src*="logo-footer"]'
  ).forEach(i => i.src =
    'https://cdn.jsdelivr.net/gh/rkgttr/mc@7/Logo_Def_Master_Fond_Bleu.png');
}
init();